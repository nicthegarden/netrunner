    ...
    const changelog = [
      ...
      },
      {
        ...
        entries: [
          ...
          { type: 'feature', text: 'World Drops & Recipes — Curated gear now appears from themed late-game activities, boss drops, and new crafting recipes, with hacking cyberware costs tuned down so the focused progression path opens earlier.' },
          ...
          { type: 'feature', text: 'Terminal Feed Notifications — Gameplay notifications now stream into the NETRUNNER terminal instead of stacking in the top-right corner, now with timestamped system-log formatting for a cleaner event feed.' },
