...
export const SHOP_ITEMS = [
   ...
   { id: 'neon_talon', name: 'Neon Talon Monoblade', icon: '🗡️', cost: 6100, category: 'weapon', tier: 4, description: '+16 damage and 5% life steal', costPerformance: 'high-value', linkedSkill: 'combat', requiredLevel: 23 },
   { id: 'fixer_exonode', name: 'Fixer Exonode Cache', icon: '📈', cost: 6900, category: 'cyberware', tier: 4, description: '+18% currency and +8% loot for traders', costPerformance: 'premium', linkedSkill: 'trading', requiredLevel: 25 },
   { id: 'drone_swarm_link', name: 'Drone Swarm Link', icon: '🛸', cost: 5600, category: 'cyberware', tier: 3, description: '+8% XP and +8% action speed for drone engineering', costPerformance: 'grind-booster', linkedSkill: 'drone_engineering', requiredLevel: 22 },
   { id: 'chrome_harvester', name: 'Chrome Harvester Rig', icon: '🦾', cost: 4700, category: 'armor', tier: 3, description: '+9 defense and +12% loot for chrome surgery', costPerformance: 'defensive', linkedSkill: 'chrome_surgery', requiredLevel: 21 },
   { id: 'daemon_forge', name: 'Daemon Forge Core', icon: '♨️', cost: 7100, category: 'cyberware', tier: 4, description: '+7 damage and +10% XP for daemon coding', costPerformance: 'premium', linkedSkill: 'daemon_coding', requiredLevel: 29 },
   { id: 'orbital_lens', name: 'Orbital Recon Lens', icon: '🔭', cost: 7350, category: 'cyberware', tier: 4, description: '+14% speed and +10% loot for intrusion', costPerformance: 'grind-booster', linkedSkill: 'intrusion', requiredLevel: 30 },
   { id: 'bloodlotus_stim', name: 'Bloodlotus Stim Pack', icon: '🌺', cost: 2200, category: 'consumable', tier: 2, description: 'Premium combat stim bundle', costPerformance: 'efficient', linkedSkill: 'combat', quantity: 8, requiredLevel: 16 },
   { id: 'quantum_patch', name: 'Quantum Patch Kit', icon: '🩹', cost: 2100, category: 'consumable', tier: 2, description: 'High-end sustain patch bundle', costPerformance: 'efficient', linkedSkill: 'biotech', quantity: 8, requiredLevel: 16 },
   { id: 'nightmarket_case', name: 'Night Market Case', icon: '🧳', cost: 2600, category: 'material', tier: 2, description: 'Premium fence-ready material bundle', costPerformance: 'efficient', linkedSkill: 'fencing', quantity: 4, requiredLevel: 18 },
